...
class OAuth2ResourceServerConfigurationPropertiesTest {
    ...
    void shouldDefaultJwkSetUriWhenNotPresent() {
        ...
        assertThat(bound.getJwt().getJwkSetUri()).isEqualTo("https://qwyck.eu.auth0.com/.well-known/jwks.json");
    }
    ...
    void shouldBindJwkSetUriWhenSpecified() {
        ...
        properties.put("jwt.jwk-set-uri", "https://qwyck.eu.auth0.com/.well-known/jwks.json");
        ...
        assertThat(bindResult.get().getJwt().getJwkSetUri()).isEqualTo("https://qwyck.eu.auth0.com/.well-known/jwks.json");
    }
}