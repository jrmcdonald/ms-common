...
class RequestLoggingInterceptorTest {
    ...
    @BeforeEach
    void beforeEach() {
        requestLoggingInterceptor = new RequestLoggingInterceptor(clock);
        MDC.clear();
    }
    ...
    void shouldLogServiceEntryMessage() {
        ...
        requestLoggingInterceptor.preHandle(httpServletRequest, httpServletResponse, new Object());
    ...
    void shouldLogServiceExitMessageWithDuration() {
        ...
        requestLoggingInterceptor.afterCompletion(httpServletRequest, httpServletResponse, new Object(), null);
